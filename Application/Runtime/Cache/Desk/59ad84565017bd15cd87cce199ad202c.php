...
<head>
    ...
    <link rel="stylesheet" href="/Public/css/resetPW.css">
</head>
<body>
<header>
    <a href="/" id="back">
...
<main>
    ...
    <section class="half .clearFix">
        <input type="text" class="fl .clearFix" placeholder="输入验证码" id="captcha"><input class="fr blue .clearFix" type="submit" value="手机验证" id="get_captcha">
    </section>

    <section class="change">
       <input type="submit" class="blue" value="更改密码" id="reset">
    </section>
...
$('#get_captcha').on('click', function(){
    ...
    $.ajax({
        url: "<?php echo U('desk/index/checkNumber');?>",
        type: "post",
        dataType: "json",
        data: {
            number: $('#number').val()
...
$('#reset').on('click', function(){
    ...
    $.ajax({
        url: "<?php echo U('desk/index/resetPW');?>",
        type: "post",
        dataType: "json",
        data: {
            username: username,
